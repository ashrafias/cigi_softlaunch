...
final String commenterImageUrl;
 ...
 CommentWidget({required this.commentId, 
...
class _CommentWidgetState extends State<CommentWidget> 
{
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
            onTap: (){
              print('inside onTap of comments widget');
            ...
            child: Row(
              ...
              children: [Flexible(flex: 1,child: Container(
                height: 40,
                width: 40,
                decoration: BoxDecoration(border: Border.all(width: 2, color: _colors[1]), 
